...
# Example skysql file path: "/path/to/SkyRL-SQL-653-data-newfmt/train.parquet"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_parquet_path", 
        default="/path/to/SkyRL-SQL-653-data-newfmt/train.parquet",
...
# Example usage:    
# python examples/data_preprocess/skysql_train.py --local_parquet_path "/path/to/SkyRL-SQL-653-data-newfmt/train.parquet"
