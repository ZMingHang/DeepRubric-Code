...
DEFAULT_DATABASE_PATH_BIRD = "./data/synsql/data/bird/dev_20240627/dev_databases"

# These should be absolute paths pointing to specific local files when preprocessing the datasets
DEFAULT_SPIDER_DEV_PROMPT = "./data/synsql/data/dev_spider.json"
DEFAULT_SPIDER_DEV_SCHEMA = "./data/synsql/data/spider/dev_gold.sql"

DEFAULT_SPIDER_TEST_PROMPT = "./data/synsql/data/test_spider.json"
DEFAULT_SPIDER_TEST_SCHEMA = "./data/synsql/data/spider/test_gold.sql"

DEFAULT_SPIDER_DK_PROMPT = "./data/synsql/data/dev_spider_dk.json"
DEFAULT_SPIDER_DK_SCHEMA = "./data/synsql/data/Spider-DK/spider_dk_gold.sql"

DEFAULT_SPIDER_SYN_PROMPT = "./data/synsql/data/dev_spider_syn.json"
DEFAULT_SPIDER_SYN_SCHEMA = "./data/synsql/data/Spider-Syn/spider_syn_gold.sql"

DEFAULT_SPIDER_REALISTIC_PROMPT = "./data/synsql/data/dev_spider_realistic.json"
DEFAULT_SPIDER_REALISTIC_SCHEMA = "./data/synsql/data/spider-realistic/spider_realistic_gold.sql"

DEFAULT_BIRD_DEV_PROMPT = "./data/synsql/data/dev_bird.json"
DEFAULT_BIRD_DEV_SCHEMA = "./data/synsql/data/bird/dev_20240627/dev.sql"
