...
def main(
    train_parquet_path='/path/to/mmau_pro/train.parquet',
    test_parquet_path='/path/to/mmau_pro/test.parquet',
    ...
    train_df_with_seq.to_parquet("/path/to/mmau_pro/train_w_length.parquet", index=False)
    ...
    test_df_with_seq.to_parquet("/path/to/mmau_pro/test_w_length.parquet", index=False)
