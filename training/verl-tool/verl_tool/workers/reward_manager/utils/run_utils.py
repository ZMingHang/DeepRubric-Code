...
def run_litellm(
    ...
    **chat_kwargs,
    ...
    # chat_kwargs["api_base"] = chat_kwargs.get("base_url", "http://localhost:8000/v1")
    # print("chat para", chat_kwargs,model_name)
...
async def run_litellm_async(
    ...
    **chat_kwargs,
    ...
    # chat_kwargs["base_url"] = chat_kwargs.get("base_url", "http://localhost:8000/v1")
