...
if __name__ == "__main__":
    ...
    parser.add_argument("--index_path", type=str, default="/path/to/ASearcher-Local-Knowledge/e5.index/e5_Flat.index", help="Corpus indexing file.")
    parser.add_argument("--corpus_path", type=str, default="/path/to/ASearcher-Local-Knowledge/wiki_corpus.jsonl", help="Local corpus file.")
