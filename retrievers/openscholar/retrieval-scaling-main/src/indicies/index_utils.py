...
if __name__ == '__main__':
    passage_dir = '/path/to/OpenScholar-DataStore-V3/passages/pes2o_v3/16-shards'
    convert_pkl_to_jsonl(passage_dir)

    pos_map_save_path = '/path/to/OpenScholar-DataStore-V3/passages/pes2o_v3/16-shards/pos_map.pkl'
